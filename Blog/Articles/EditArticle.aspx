<%@ Page Language="cs" MasterPageFile="~/Main.Master" AutoEventWireup="True"
    CodeBehind="EditArticle.aspx.cs" Inherits="EditArticle" ValidateRequest="false" %>
...
<asp:Content ID="CntContent" runat="server" ContentPlaceHolderID="CphHome">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <ftb:freetextbox id="TxtContents" runat="server" autoconfigure="Full" text=""
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                ...
                <asp:RequiredFieldValidator ID="RfvCategories" runat="server" ErrorMessage="* Categories are required" ControlToValidate="LbxCategories"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="form-group">
